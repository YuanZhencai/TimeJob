...
public class Publisher {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        while (total < 10) {
            ...
            total += count;
            logger.info("Published '" + count + "' of '" + total + "' price messages");
            try {
                Thread.sleep(1000);
    ...
    protected void sendMessage(String[] stocks) throws JMSException {
        ...
        Destination destination = session.createQueue("unsQueue");
        Message message = createStockMessage(stock, session);
        logger.info("Sending: " + ((ActiveMQMapMessage) message).getContentMap() + " on destination: " + destination);
