...
import com.ibm.filenet.helper.vo.PropertyVo;
...
public class WorkItemHelper {
    public static void append(Object obj, ToStringBuilder b) {
        if ((!(obj instanceof VWQueueElement)) && (!(obj instanceof VWStepElement)) && (!(obj instanceof VWWorkObject))) throw new IllegalArgumentException(
                obj + " is not one of queue element, step element or work object");
    ...
    public static void appendFields(Object o, String[] fieldNames, ToStringBuilder b) {
        if ((!(o instanceof VWLogElement)) && (!(o instanceof VWQueueElement))) throw new IllegalArgumentException(o
    ...
    public static List<WorkItem> getWorkItemsFromVWRosterElements(List<VWRosterElement> vwRosterElements, String[] fieldNames)
            throws VWException {
    ...
    public static List<WorkItem> getWorkItemsFromVWQueueElements(List<VWQueueElement> vwQueueElements, String[] fieldNames)
            throws VWException {
        List<WorkItem> workItems = new ArrayList<WorkItem>();
    ...
    public static List<WorkItem> getWorkItemsFromVWStepElements(List<VWStepElement> vwStepElements, String[] fieldNames)
            throws VWException {
        List<WorkItem> workItems = new ArrayList<WorkItem>();
    ...
    public static List<WorkItem> getWorkItemsFromVWWorkObjects(List<VWWorkObject> vwWorkObjects, String[] fieldNames)
            throws VWException {
        List<WorkItem> workItems = new ArrayList<WorkItem>();
    ...
    public static WorkItem getWorkItemFromVWRosterElement(VWRosterElement vwRosterElement, String[] fieldNames)
            throws VWException {
