...
public abstract interface PEConstants {
    ...
    public static final String SYSTEM_FIELD_CREATE_TIME = "F_CreateTime";
    public static final String SYSTEM_FIELD_ENQUEUE_TIME = "F_EnqueueTime";
    ...
    public static final String SYSTEM_FIELD_STEP_STATUS = "F_StepStatus";
    ...
    public static final String PE_SYSTEM_FIELD_EVENTTYPE = "F_EventType";
    public static final String PE_SYSTEM_FIELD_WORKFLOW_NUMBER = "F_WorkFlowNumber";
    public static final String PE_SYSTEM_FIELD_USERID = "F_UserId";
}