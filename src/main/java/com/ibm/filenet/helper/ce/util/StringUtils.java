...
public class StringUtils {
    ...
    public static String getDate(Object datetime) {
        if (datetime != null) {
            if (datetime.toString().length() > 10) { return datetime.toString().substring(0, 10); }
    ...
    public static String getTime(Object datetime) {
        if (datetime != null) {
            if (datetime.toString().length() > 19) { return datetime.toString().substring(0, 19); }
            return datetime.toString();
        }
    ...
    public static String getTime(String datetime) {
        if (datetime != null) {
            if (datetime.length() > 19) { return datetime.substring(0, 19); }
            return datetime;
        }
